<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\webset.html";i:1533918960;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\layout.html";i:1533918960;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/common\layout.html";i:1534520952;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\left.html";i:1564049553;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="wrapper">
                        ...
                        <form method="post" class="form-horizontal">
						 <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">ZID</span>
                                         <input type="text" class="form-control" value="<?php echo $web['zid']; ?>" disabled>
                                </div>
                                </div>
                            
							 <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">站点类型</span>
                                         <select name="super" class="form-control" <?php if($zid == 0): ?>disabled<?php endif; ?>>
									<option value="0" <?php if($web['super'] == 0): ?>selected<?php endif; ?>>普通分站</option>
									<option value="1" <?php if($web['super'] == 1): ?>selected<?php endif; ?>>二级主站</option>
									<option value="2" <?php if($web['super'] == 2): ?>selected<?php endif; ?>>超级主站</option>{/if}
									<option value="3" <?php if($web['super'] == 3): ?>selected<?php endif; ?>>合作伙伴</option>{/if}
									<?php if(ZID == 1 || $web['super'] == 4): ?><option value="4" <?php if($web['super'] == 4): ?>selected<?php endif; ?>>至尊分销</option><?php endif; ?>
									</select>
		                        </div>
                                </div>
							 <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">网站域名</span>
                                         <input type="text" name="domain" class="form-control" value="<?php echo $web['domain']; ?>" <?php if(ZID != 1): ?>disabled<?php endif; ?>>
		                        </div>
                                </div>
		                     <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">额外域名</span>
                                         <input type="text" name="domain2" class="form-control" value="<?php echo $web['domain2']; ?>">
							...
							<?php if(ZID == 1 || $zid != 0): ?>
							 <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">站点到期</span>
                                         <input type="datetime" name="endtime" class="form-control" value="<?php echo $web['endtime']; ?>">
		                        </div>
                                </div>
							...
							<!--div class="form-group">
								<label class="col-lg-3 control-label">全套代挂价格(成本<?php echo config('zz_price_all'); ?>元)</label>
								<div class="col-lg-8">
									<input type="text" name="price_all" class="form-control"
										   value="<?php echo $web['price_all']; ?>">
									<div class="alert alert-info">分别对应普通会员与VIP1～5等级，用|分隔，例如3|2|1.8|1.5|1|0.8
		                            </div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-3 control-label">单个项目代挂价格(成本<?php echo config('zz_price_dx'); ?>元)</label>
								<div class="col-lg-8">
									<input type="text" name="price_dx" class="form-control"
										   value="<?php echo $web['price_dx']; ?>">
									<div class="alert alert-info">分别对应普通会员与VIP1～5等级，用|分隔，例如0.8|0.6|0.5|0.4|0.3|0.1
		                            </div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-3 control-label">VIP会员开通价格</label>
								<div class="col-lg-8">
									<input type="text" name="price_vip" class="form-control"
										   value="<?php echo $web['price_vip']; ?>">
									<div class="alert alert-info">分别对应VIP1～5等级，用|分隔，例如3|5|10|15|22
		                            </div>
								</div>
					
							</div-->
							<?php if($web['super'] != 0 || ZID == 1): ?>
							...
							<div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">站长QQ</span>
                                         <input type="text" name="qq" class="form-control" value="<?php echo $web['qq']; ?>">
                                </div>
                                </div>
                            <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">站点名称</span>
                                         <input type="text" name="name" class="form-control" value="<?php echo $web['name']; ?>">
                                </div>
                                </div>
                            <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">SEO标题</span>
                                          <textarea name="title" rows="5"
                                          class="form-control"><?php echo getHtmlCode($web['title'],true); ?></textarea>
                                </div>
                                </div>
                              <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">SEO关键词</span>
                                           <textarea name="keywords" rows="5" class="form-control"><?php echo getHtmlCode($web['keywords'],true); ?></textarea>
                                </div>
                                </div>
                             <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">SEO标题</span>
                                           <textarea name="description" rows="5" class="form-control"><?php echo getHtmlCode($web['description'],true); ?></textarea>
                                </div>
                                </div>
                              <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">用户面板公告</span>
                                           <textarea name="gg_panel" rows="5" class="form-control"><?php echo getHtmlCode($web['gg_panel'],true); ?></textarea>
                                </div>
                                </div>
                            <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">QQ添加公告</span>
                                           <textarea name="gg_qqadd" rows="5" class="form-control"><?php echo getHtmlCode($web['gg_qqadd'],true); ?></textarea>
                                </div>
                                </div>
                            <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">代挂下单公告</span>
                                           <textarea name="gg_dgadd" rows="5" class="form-control"><?php echo getHtmlCode($web['gg_dgadd'],true); ?></textarea>
                                </div>
                                </div>
                            <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">邀请列表公告</span>
                                           <textarea name="gg_invite" rows="5" class="form-control"><?php echo getHtmlCode($web['gg_invite'],true); ?></textarea>
                                </div>
                                </div>
 ...
 <div class="list-group-item">
						...
						<div class="alert alert-info">提示：所有价格单位均为RMB/元，可精确到小数点后两位；所有比例均为不大于100的正整数</div>
                    </div>
                </div>
            </div>
        </div>
