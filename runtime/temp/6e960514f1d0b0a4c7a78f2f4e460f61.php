<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\index.html";i:1534775700;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\layout.html";i:1533918960;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/common\layout.html";i:1534520952;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\left.html";i:1564448391;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
window.alert("<?php echo getHtmlCode(config('zz_fztc'),true); ?>");
					 ...
					 <div class="wrapper">
                        ...
                        <div class="col-lg-4">
                            <div class="panel b-a" draggable="true">
                                ...
                                <div class="text-center m-b clearfix">
                                    ...
                                    <div class="h4 font-thin m-t-sm">站长</div>
                                    <span class="text-muted text-xs block"><?php echo $userInfo['user']; ?> UID:<?php echo $userInfo['uid']; ?></span>
                                </div>
                                ...
                                <br />
                                    <div class="col-xs-12">
                                        <div class="inline m-t-sm m-b-sm"><div class="h1 text-info font-thin h2">帐号余额:<?php echo $userInfo['point']; ?>元</div></div>
                                    </div>
                                </div>
                                
                                    
                                <div class="btn-group btn-group-justified">
                                    <a href="<?php echo url('kmList'); ?>" class="btn btn-info" >卡密管理</a>
                                    <a href="/index/panel/recharge.html" class="btn btn-primary" >账户充值</a>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="panel panel-info" draggable="true">
                                <div class="panel-heading font-bold">分站后台公告</div>
                                <div class="panel-body">
								
<?php echo getHtmlCode(config('zz_gg_admin'),true); ?>
             ...
             <div class="col-lg-4">
                            <div class="panel panel-info" draggable="true">
                                <div class="panel-heading font-bold">站点更新进度表</div>
                                <div class="panel-body">
      <table width="100%" bordercolor="#FFFFFF" border="1">                      
    <tbody> 
     <tr>
     <td>
    <font size="3">优化站点程序★漏洞修补</font>
     </td>
     </tr>
     <tr> 
      <td>
     ...
     <tr>
     <td>
     <font size="3"> 模板优化★美化模板</font>
     </td>
     </tr>
     <tr> 
      <td>
      <div class="progress progress-striped active">
        <div class="progress-bar progress-bar-info"  role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
        </div>
      </div>
      </td>
     </tr> 
     ...
     <tr>
     <td>
     <font size="3">程序更多功能开发★多功能</font>
     </td>
     </tr>
     <tr> 
      <td>
      <div class="progress progress-striped active">
        <div class="progress-bar progress-bar-danger"  role="progressbar" aria-valuenow="33" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
        </div>
      </div>
      </td>
     </tr> 
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="panel panel-info" draggable="true">
                                <div class="panel-heading font-bold">我的站点数据</div>
                                <div class="panel-body text-center">
                                    
                                    <div class="col-sm-3 col-xs-6">
                                        <div class="block panel padder-v bg-primary item">
                                            <span class="text-white font-thin h1 block"><?php echo $amount['user']; ?></span>
                                            <span class="text-muted text-xs">总用户数</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-xs-6">
                                        <div class="block panel padder-v bg-info item">
                                            <span class="text-white font-thin h1 block"><?php echo $amount['order']; ?></span>
                                            <span class="text-muted text-xs">总订单数</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-xs-6">
                                        <div class="block panel padder-v bg-success item">
                                            <span class="text-white font-thin h1 block"><?php echo $amount['qq']; ?></span>
                                            <span class="text-muted text-xs">总QQ数</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-xs-6">
                                        <div class="block panel padder-v bg-dark item">
                                            <span class="text-white font-thin h1 block"><?php echo $amount['web']; ?></span>
                                            <span class="text-muted text-xs">总站点数</span>
                                        </div>
                                    </div>
