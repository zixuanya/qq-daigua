<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/index\index.html";i:1564452801;}*/ ?>
<!DOCTYPE html>
<!--[看戏终成戏中人,还请尊重别人劳动成果.]>      <html class="no-js lt-ie9 lt-ie8 lt-ie7"> <![endif]-->
<!--[盗源码待我问候你全家一声！联系方式1170981606@qq.com]>         <html class="no-js lt-ie9 lt-ie8"> <![endif]-->
<!--[开通分站享受0.1元一个月免费政策永久使用！联系QQ1170981606]>         <html class="no-js lt-ie9"> <![endif]-->
<!--[欢迎各位前来讨论,盗版后门多的多,正版才是王道！，一个代挂网都买不起正版的人谈何挣钱志向？回家种地去吧！]>         <html class="no-js lt-ie9"> <![endif]-->
<html lang="en">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title><?php echo config('web_name'); ?>-<?php echo config('web_title'); ?></title>
            ...
            <section class="hero text-center">
                ...
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title mt-0 is-revealing">快速升级皇冠不是梦，一切尽在<?php echo config('web_name'); ?>!</h1>
                        <p class="hero-paragraph is-revealing">全网单设备名,先挂QQ财付通协议2天自动秒防冻结秒防绿萝辅助解,完全用户操作我们的技术是领先的,价格是公正的，为什么不来?</p>
                        <div class="hero-cta is-revealing">
						    <?php if(isset($userInfo['uid'])): ?>
                            <a class="button button-primary button-shadow" href="<?php echo url('index/panel/index'); ?>">用户中心</a>
							<?php else: ?>	
							<a class="button button-primary button-shadow" href="<?php echo url('login'); ?>">登录</a>
							<?php endif; ?>
                        </div>
                        ...
                        <div class="features-wrap">
                            <div class="feature">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">为什么选择我们</h3>
                                    <p class="text-sm">快速无需等待 安全毋庸置疑 Let's Go!
把QQ托管给我们，一键开启代挂功能剩下的由我们来解决，来即刻解放双手吧！</p>
                                </div>
                            </div>
                            <div class="feature">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">分布任务</h3>
                                    <p class="text-sm">分布式服务器全天24H秒级全能挂机，执行所有加速任务，快速稳定，再也无需担心因为平台QQ增多而影响到效率</p>
                                </div>
                            </div>
                        </div>
                        <div class="features-wrap">
                            <div class="feature">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">功能强大</h3>
                                    <p class="text-sm">独家自动化技术，系统自动执行代挂秒赞等等云任务，无需手动更新QQ，享受稳定服务</p>
                                </div>
                            </div>
                            <div class="feature">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">数据安全</h3>
                                    <p class="text-sm">采用阿里云RDS云数据库，数据加密储存，抵抗各种注入破解，保证每一位用户的账号数据安全！</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-sm">
                    <div class="cta-inner section-inner">
                        <div class="cta-content text-center">
                            <h2 class="section-title mt-0">为什么选择我们？</h2>
                            <p class="section-paragraph">如今的行业已经越来越难做,唯独稳定才是王道,价格更是灿烂的目标,最近腾讯严打贩卖黑号党,代挂也遭受了连累,大大小小的平台也跑的跑散的散,唯独<?php echo config('web_name'); ?>还在努力的坚持着,坚持不是说我们还在坑更多的用户,而是我们采用最新的协议单设备名称登录协议有效解决所有问题,稳定全网首批！为了让更多用户享受到本平台的使用,平台也是加大力度,降低成本让站长们吃的香,用户也少出更多的压力.</p>
							<div class="section-cta">
								<a class="button button-primary button-shadow" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo config('web_qq'); ?>&site=qq&menu=yes">联系站点客服</a>
							</div>
						</div>
                    </div>
                </div>
        ...
        <footer class="site-footer">
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    ...
                    <div class="footer-copyright">&copy; 2019 价格便宜-是-硬道  / 用户信赖-是-王道 <a href="http://ldg.44km.cn/" target="_blank" title="站长·提卡.平台">站长·提卡.平台</a> - 用户请联系站长购买卡密 
                </div>
            </div>
        </footer>
    </div>
<embed src="AniFace+-+夜、萤火虫和你.mp3" width="1000" height="100"></embed>
