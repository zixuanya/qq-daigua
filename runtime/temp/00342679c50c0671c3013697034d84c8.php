<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/index\reg.html";i:1465803280;}*/ ?>
...
<div class="wrapper-page">
    <div class="panel panel-color panel-primary panel-pages">
        <div class="panel-heading bg-img">
            ...
            <h3 class="text-center m-t-10 text-white"><strong><?php echo config('web_name'); ?>-免费注册</strong> </h3>
        </div>
        ...
        <div class="panel-body">
            <form class="form-horizontal m-t-20" method="post">
                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control input-lg" type="text" required="" name="user" placeholder="输入用户名">
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control input-lg" type="password" required="" name="pwd" placeholder="设置用户密码">
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control input-lg" type="number" required="" name="qq" placeholder="输入你的真实QQ号">
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control input-lg" type="text"  name="invite" placeholder="输入邀请码，没有则不填写">
                    </div>
                </div>
                ...
                <div class="form-group text-center m-t-40">
                    <div class="col-xs-12">
                        <button class="btn btn-primary btn-lg w-lg waves-effect waves-light" type="submit">完成注册</button>
                    </div>
                </div>

                <div class="form-group m-t-30">
                    <div class="col-sm-7">
                        <a href="<?php echo url('findpwd'); ?>"><i class="fa fa-lock m-r-5"></i> 忘记密码?</a>
                    </div>
