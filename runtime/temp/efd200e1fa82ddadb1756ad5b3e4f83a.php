<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\priceset.html";i:1533918960;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\layout.html";i:1533918960;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/common\layout.html";i:1534520952;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\left.html";i:1564049553;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="wrapper">
            ...
            <div class="widget-body table-responsive">
                <div class="alert alert-warning text-center">
                    ...
                    全套代挂价格(成本<?php echo config('zz_price_all'); ?>元)，单个项目代挂价格(成本<?php echo config('zz_price_dx'); ?>元)
                </div>
				
				 <div class="col-lg-3 col-md-4 col-sm-6 del34">
                      <div class="panel b-a">
                        <div class="list-group-item bg-dark m-b-sm">          
                          <span class="text-lt">全套价格设置</span>
                          
                        </div>
                        <div class="item m-l-n-xxs m-r-n-xxs">
                          <div class="bottom wrapper bg-gd-dk text-white" style="width:100%">            
                            <div class="text-u-c h3 text-default">全套代挂</div>
                          </div>
                          <img src="http://daigua.yuncd.cc/data/img.php?time=722" class="img-full">
                        </div>
                        <ul class="list-group no-radius alt">
						 <form method="post">
						<input type="hidden" name="action" value="set">
                                <input type="hidden" name="sp" value="all">
                          <div class="list-group-item">
                                    <div class="input-group">
									 <input type="hidden" name="action" value="set">
                                <input type="hidden" name="sp" value="all">
                                        <span class="input-group-addon">普通用户</span>
                                         <input type="text" name="p0" value="<?php if($pall[0]): ?><?php echo $pall[0]; else: ?><?php echo config('zz_price_all'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
                           ...
                           <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP1用户</span>
                                        <input type="text" name="p1" value="<?php if(isset($pall[1])): ?><?php echo $pall[1]; else: ?><?php echo config('zz_price_all'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
                           ...
                           <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP2用户</span>
                                         <input type="text" name="p2" value="<?php if(isset($pall[2])): ?><?php echo $pall[2]; else: ?><?php echo config('zz_price_all'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
                           ...
                           <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP3用户</span>
                                         <input type="text" name="p3" value="<?php if(isset($pall[3])): ?><?php echo $pall[3]; else: ?><?php echo config('zz_price_all'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
								 ...
								 <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP4用户</span>
                                        <input type="text" name="p4" value="<?php if(isset($pall[4])): ?><?php echo $pall[4]; else: ?><?php echo config('zz_price_all'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
								 ...
								 <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP5用户</span>
                                         <input type="text" name="p5" value="<?php if(isset($pall[5])): ?><?php echo $pall[5]; else: ?><?php echo config('zz_price_all'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
				 ...
				 <div class="col-lg-3 col-md-4 col-sm-6 del34">
                      <div class="panel b-a">
                        <div class="list-group-item bg-dark m-b-sm">          
                          <span class="text-lt">单项价格设置</span>
                          
                        </div>
                        <div class="item m-l-n-xxs m-r-n-xxs">
                          <div class="bottom wrapper bg-gd-dk text-white" style="width:100%">            
                            <div class="text-u-c h3 text-default">单项代挂</div>
                          </div>
                          <img src="http://daigua.yuncd.cc/data/img.php?time=922" class="img-full">
                        </div>
                        <ul class="list-group no-radius alt">
						 <form method="post">
						<input type="hidden" name="action" value="set">
                          ...
                          <div class="list-group-item">
                                    <div class="input-group">
									 <input type="hidden" name="action" value="set">
                                <input type="hidden" name="sp" value="dx">
                                        <span class="input-group-addon">普通用户</span>
                                         <input type="text" name="p0" value="<?php if(isset($pdx[0])): ?><?php echo $pdx[0]; else: ?><?php echo config('zz_price_dx'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
                           ...
                           <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP1用户</span>
                                       <input type="text" name="p1" value="<?php if(isset($pdx[1])): ?><?php echo $pdx[1]; else: ?><?php echo config('zz_price_dx'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
                           ...
                           <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP2用户</span>
                                         <input type="text" name="p2" value="<?php if(isset($pdx[2])): ?><?php echo $pdx[2]; else: ?><?php echo config('zz_price_dx'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
                           ...
                           <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP3用户</span>
                                        <input type="text" name="p3" value="<?php if(isset($pdx[3])): ?><?php echo $pdx[3]; else: ?><?php echo config('zz_price_dx'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
								 ...
								 <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP4用户</span>
                                        <input type="text" name="p4" value="<?php if(isset($pdx[4])): ?><?php echo $pdx[4]; else: ?><?php echo config('zz_price_dx'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
								 ...
								 <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP5用户</span>
                                         <input type="text" name="p5" value="<?php if(isset($pdx[5])): ?><?php echo $pdx[5]; else: ?><?php echo config('zz_price_dx'); endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
					 ...
					 <div class="col-lg-3 col-md-4 col-sm-6 del34">
                      <div class="panel b-a">
                        <div class="list-group-item bg-dark m-b-sm">          
                          <span class="text-lt">VIP价格设置</span>
                          
                        </div>
                        <div class="item m-l-n-xxs m-r-n-xxs">
                          <div class="bottom wrapper bg-gd-dk text-white" style="width:100%">            
                            <div class="text-u-c h3 text-default">VIP售价</div>
                          </div>
                          <img src="http://daigua.yuncd.cc/data/img.php?time=3789" class="img-full">
                        </div>
                        <ul class="list-group no-radius alt">
						 <form method="post">
						 <input type="hidden" name="action" value="set">
                                <input type="hidden" name="sp" value="vip">
                          <div class="list-group-item">
                                    <div class="input-group">
									 <input type="hidden" name="action" value="set">
                                <input type="hidden" name="sp" value="vip">
                           ...
                           <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP1用户</span>
                                      <input type="text" name="p1" value="<?php echo $pvip[0]; ?>"
                                           class="form-control">
                                    </div>
                                </div>
                           ...
                           <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP2用户</span>
                                        <input type="text" name="p2" value="<?php if(isset($pvip[1])): ?><?php echo $pvip[1]; else: ?><?php echo $pvip[0]; endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
                           ...
                           <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP3用户</span>
                                      <input type="text" name="p3" value="<?php if(isset($pvip[2])): ?><?php echo $pvip[2]; else: ?><?php echo $pvip[0]; endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
								 ...
								 <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP4用户</span>
                                       <input type="text" name="p4" value="<?php if(isset($pvip[3])): ?><?php echo $pvip[3]; else: ?><?php echo $pvip[0]; endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
								 ...
								 <div class="list-group-item">
                                    <div class="input-group">
                                        <span class="input-group-addon">VIP5用户</span>
                                        <input type="text" name="p5" value="<?php if(isset($pvip[4])): ?><?php echo $pvip[4]; else: ?><?php echo $pvip[0]; endif; ?>"
                                    class="form-control">
                                    </div>
                                </div>
