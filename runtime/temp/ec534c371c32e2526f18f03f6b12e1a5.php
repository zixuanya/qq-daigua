<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\userlist.html";i:1533918960;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\layout.html";i:1533918960;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/common\layout.html";i:1534520952;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\left.html";i:1564448391;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="panel panel-info">
                <div class="panel-body text-center">
                    <div class="list-group-item bg-dark">
                        <img alt="image" class="img-circle" src="//q4.qlogo.cn/headimg_dl?dst_uin=<?php echo $user['qq']; ?>&amp;spec=100" width="100" height="100">
                    </div>
                    <h5 class="text-success">用户名: <?php echo $user['user']; ?></h5>
					 <h5 class="text-success">UID: <?php echo $user['uid']; ?></h5>
					 <h5 class="text-success">余额: <?php echo $user['point']; ?></h5>
					 <h5 class="text-success">所属站点: <?php echo $user['zid']; ?></h5>
					  <h5 class="text-success">QQ: <?php echo $user['qq']; ?></h5>
					   <h5 class="text-success">注册时间: <?php echo $user['regtime']; ?></h5>
                                ...
                                <form method="post">
                                    ...
                                    <select name="power">
                                        ...
                                        <?php $__FOR_START_23160__=1;$__FOR_END_23160__=6;for($i=$__FOR_START_23160__;$i < $__FOR_END_23160__;$i+=1){ ?>
                    ...
                    <div class="text-center m-b-sm">
                        ...
                        <a class="btn btn-outline btn-warning" href="<?php echo url('userinfo',['uid'=>$user['uid']]); ?>">修改</a>
						<a class="btn btn-danger" href="?action=del&uid=<?php echo $user['uid']; ?>" onclick="if(!confirm('确认删除吗?')){return false;}" title="删除QQ:<?php echo $qq['uin']; ?>"}>删除</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="text-center"><?php echo $pageList->showPage(); ?></div>
            </div>
        </div>
    </div>
</div>
