<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\selectmb.html";i:1533918960;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\layout.html";i:1533918960;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/common\layout.html";i:1534520952;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/admin\left.html";i:1564049553;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="wrapper">
            ...
            <div class="panel-body">
				...
				<div class="list-group-item">
                                ...
                                <?php if(is_array($mbList) || $mbList instanceof \think\Collection): $i = 0; $__LIST__ = $mbList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mb): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $mb; ?>" <?php if($xzmb == $mb): ?>selected<?php endif; ?>><?php echo $mb; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                                    </div>
                                </div>
