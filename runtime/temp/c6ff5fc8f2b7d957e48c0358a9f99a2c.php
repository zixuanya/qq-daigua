<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/index\login.html";i:1564447507;}*/ ?>
...
<div class="wrapper-page">
    <div class="panel panel-color panel-primary panel-pages">
        <div class="panel-heading bg-img">
            ...
            <h3 class="text-center m-t-10 text-white"><strong><?php echo config('web_name'); ?>-登录</strong> </h3>
        </div>
        ...
        <div class="panel-body">
            <form class="form-horizontal m-t-20" method="post">
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control input-lg" type="text" required="" name="user" placeholder="用户名/QQ号码">
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control input-lg" type="password" required="" name="pwd" placeholder="输入用户密码">
                    </div>
                </div>
                ...
                <div class="form-group m-t-30">
                    ...
                    <div class="col-sm-5 text-right">
                        <a href="<?php echo url('reg'); ?>">免费注册</a>
                    </div>
                </div>
            </form>
        </div>
