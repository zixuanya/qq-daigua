<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/panel\recharge.html";i:1533918960;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/panel\layout.html";i:1533918960;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/common\layout.html";i:1534520952;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/panel\left.html";i:1533918960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script type="text/javascript"> window.onload=function(){ alert
("系统管理员：充值后请耐心等待网页提示"); } 
</script>
				...
				<div class="wrapper">
                    <div class="col-lg-8 col-md-12 col-lg-offset-2 text-center" role="main">
                        <div class="panel panel-info">
								...
								<div class="list-group-item">充值无需等待，请显示充值成功在返回</div>
                        </div>
                    </div>
...
<div class="row">
 ...
 <div class="panel-heading font-bold">
			...
			<div class="list-group-item"><b>我当前的账户余额：<span style="font-size:16px; color:#FF6133;"><?php echo $userInfo['point']; ?></span> ￥</b></div>
            ...
            <div class="panel-body">
				...
				<input type="hidden" name="type" value="alipay">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-lg-8">
							<?php if(config('zz_alipay_api')): ?><label><input type="radio" name="paytype" value="alipay" checked>支付宝</label><?php endif; if(config('zz_qqpay_api')): ?><label><input type="radio" name="paytype" value="qqpay">QQ钱包</label><?php endif; if(config('zz_wxpay_api')): ?><label><input type="radio" name="paytype" value="wxpay">微信支付</label><?php endif; ?>
						</div>
                    </div>
			<div class="line line-dashed b-b line-md"></div>
                    <div class="form-group">
