<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/panel\rmblist.html";i:1533918960;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/panel\layout.html";i:1533918960;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/common\layout.html";i:1534520952;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/panel\left.html";i:1533918960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section id="containerdemo">
 ...
 <div class="wrapper">
            ...
            <div class="list-group-item bg-dark m-b-sm" class="panel-heading">
                收支明细
            ...
            <div class="panel-body">
                <div class="col-lg-12 table-responsive">
                    <table class="table table-bordered table-condensed table-hover table-striped table-vertical-center">
                        ...
                        <tbody>
                        <?php if(is_array($points) || $points instanceof \think\Collection): $i = 0; $__LIST__ = $points;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$point): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td class="text-center"><?php echo $point['id']; ?></td>
                            <td class="text-center"><?php echo $point['action']; ?></td>
                            <td class="text-center"><?php echo $point['point']; ?></td>
                            <td><?php echo $point['bz']; ?></td>
                            <td class="text-center"><?php echo $point['addtime']; ?></td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <tr class="text-center">
                            <td colspan="10"><?php echo $pageList->showPage(); ?></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
