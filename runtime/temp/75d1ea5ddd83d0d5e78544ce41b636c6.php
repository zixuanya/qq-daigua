<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/panel\qqlist.html";i:1533918960;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/panel\layout.html";i:1533918960;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/common\layout.html";i:1534520952;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view2/panel\left.html";i:1533918960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="col">  
                <div class="bg-light lter b-b wrapper-sm ng-scope">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo url('qqadd'); ?>" >添加代挂</a></li>
...
<div class="panel-heading font-bold text-left">QQ管理列表</div>
                                ...
                                <div class="col-sm-12">
                                    <div class="btn-group dropdown m-l-xs" style="float:left;">
                                      <button type="button" class="btn btn-info" data-toggle="dropdown" data-toggle="dropdown">
                                        QQ数量                                        <span class=""></span>
                                      </button>
                                    
                                    </div>
                                    <button class="btn btn-primary m-l-xs"><?php echo count($qqList); ?></button>
                                    <a href="<?php echo url('qqAdd'); ?>" class="btn btn-sm btn-dark m-l-xs" ><i class="fa fa-plus"></i> 添加代挂</a>
<div class="panel-body">
       ...
       <div class="col-lg-3 col-md-4 col-sm-6 m-b-xs">
            <div class="panel panel-success">
                <div class="panel-body text-center">
                    <div class="m-b-sm">
                        <img alt="image" class="img-circle" src="//q4.qlogo.cn/headimg_dl?dst_uin=10000&amp;spec=100"
                             width="100" height="100">
                    </div>
                    <h2 class="text-success">虚拟占位</h2>
                    <h3 class="text-warning">点击按钮添加QQ</h3>
                    <hr>
                    <div style="width:100%; height:3px;"></div>
                    <div class="text-center m-b-sm">
                        <a class="btn btn-w-m btn-info btn-dialog" href="/index.php/index/panel/qqAdd.html" title="添加QQ">添加QQ</a>
                    </div>
                </div>
            </div>
        </div>
		...
		<?php if(is_array($qqList) || $qqList instanceof \think\Collection): $i = 0; $__LIST__ = $qqList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$qq): $mod = ($i % 2 );++$i;?>
            ...
            <div class="panel panel-info">
                <div class="panel-body text-center">
                    <div class="m-b-sm">
                        <img alt="image" class="img-circle" src="//q4.qlogo.cn/headimg_dl?dst_uin=<?php echo $qq['uin']; ?>&amp;spec=100" width="100" height="100">
                    </div>
                    <h2 class="text-success"># <?php echo $qq['uin']; ?></h2>
                    <h3 class="text-warning">状态：<font color="green"><?php echo getQqzt($qq['zt']); ?></font></h3>
                    <hr>
                    <div style="width:100%; height:3px;"></div>
                    <div class="text-center m-b-sm">
                        <a class="btn btn-outline btn-success btn-dialog" href="<?php echo url('qqAdd'); ?>?qid=<?php echo $qq['qid']; ?>}" title="更新密码">更新密码</a>
                        <a class="btn btn-outline btn-warning" href="<?php echo url('qqInfo',['qid'=>$qq['qid']]); ?>">设置</a>
						<a class="btn btn-danger" href="<?php echo url('qqList'); ?>?qid=<?php echo $qq['qid']; ?>&action=del" onclick="if(!confirm('确认删除QQ:<?php echo $qq['uin']; ?>吗?')){return false;}" title="删除QQ:<?php echo $qq['uin']; ?>"}>删除</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">get_list("/other/qqlist/count/0.html");</script>
        </section>
